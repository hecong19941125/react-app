...
class Course extends Component {
  ...
  handleTableChange = async (page, limit) => {
    ...
    await this.props.getCourseCategoryList({ page, limit })
    this.setState({
      tableLoading: false
    })
  ...
  render() {
    ...
    courseCategoryList = courseCategoryList.items.map((item, index) => ({
      ...item,
      index: index + 1
    }))
    const {
    ...
    const total = this.props.courseCategoryList.total
